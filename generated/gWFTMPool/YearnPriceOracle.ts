...
export class YearnPriceOracle extends ethereum.SmartContract {
  static bind(address: Address): YearnPriceOracle {
    return new YearnPriceOracle("YearnPriceOracle", address);
  }
